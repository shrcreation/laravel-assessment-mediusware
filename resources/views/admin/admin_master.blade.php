...
<head>
    ...
    <!-- DataTables -->
    <link type="text/css" href="{{ asset('backend/assets/libs/datatables.net-bs4/css/dataTables.bootstrap4.min.css') }}"
        rel="stylesheet" />
    ...
    <link type="text/css" href="https://cdn.jsdelivr.net/bootstrap.tagsinput/0.8.0/bootstrap-tagsinput.css"
        rel="stylesheet">
...
<body class="bg-dark" data-topbar="dark">
