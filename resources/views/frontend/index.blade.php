                ...
                <div class="col-xl-3">
                    <div class="services__item">
                        ...
                        <div class="services__content">
                            ...
                            <a class="btn border-btn" href="services-details.html">Read more</a>
                        </div>
                    </div>
                </div>
                <div class="col-xl-3">
    ...
    <section class="blog">
        <div class="container">
                    ...
                    <div class="blog__post__item">
                        ...
                        <div class="blog__post__content">
                            ...
                            <h3 class="title"><a href="blog-details.html">Facebook design is dedicated to what's new in
                                    design</a></h3>
                            <a class="read__more" href="blog-details.html">Read mORe</a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 col-sm-9">
            ...
            <div class="blog__button text-center">
                <a class="btn" href="blog.html">more blog</a>
            </div>
        </div>
    </section>
    <!-- blog-area-end -->
