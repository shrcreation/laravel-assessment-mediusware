...
<head>
    ...
    <title>SHR_Creation - Personal Portfolio</title>
    <meta name="shr_creation personal portfolio" content="">
    <meta name="viewport" content="width=device-width, initial-scale=1">

    <link type="image/x-icon" href="{{ asset('frontend/assets/img/favicon.png') }}" rel="shortcut icon">
    ...
    <link href="{{ asset('frontend/assets/css/default.css') }}" rel="stylesheet">
